...
public class MainActivity extends AppCompatActivity
    ...
    public void clickClear(View v){
        ...
        Log.e(LOG_TAG, "Everything is Quiet");
    }
    ...
    public void clickExit(View v){
        ...
        //destroy service
        //myService.onDestroy();
        Log.i("MyService", "Stopping.");
        Log.i("MyService", "Stop.");
        finish();
        System.exit(0);
    }
     ...
     * If the message has something in it, then the phone moved.
     *
     * we check this by seeing:
     *
     * if result != null
     *      then we set the textview to "the phone moved!"
     *
     * otherwise the phone was not moved
     */
